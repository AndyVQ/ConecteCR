...
class ReportesSerializer(ModelSerializer):
    ...
    class Meta:
        model = Reportes
        fields = ["id","nombre_usuario","usuario","comunidad","nombre_reporte","descripcion_reporte","fecha_reporte","direccion_reportes","imagen_reporte","gravedad_reporte","comentario_reporte","nombre_comunidad"]
